...
<section>
  ...
  <p>Когда не пишу код, люблю заниматься дизайном, читать книги и общаться с другими разработчиками. Если вы хотите обсудить проект или просто пообщаться, не стесняйтесь связаться со мной!</p>
